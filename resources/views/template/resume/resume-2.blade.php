@section('styles')
    ...
    <div class="custom-resume-card"
        ...
        <div class="resume-card-inner" style="padding: 50px 35px; position: relative;">
                ...
                <li>
                    <div class="profile-info"
                         style="background-repeat: no-repeat;
                             ...
                             background-size: cover;display: inline-block;width: 200px;height: 200px;
                             background-image: url('{{key_exists('image', $resume->contact_info) ? '/storage/'.$resume->contact_info['image'] : '/storage/images/user_resume/default.jpg'}}');border-radius: 100%;margin: 0px auto ;">

                    </div>
                </li>
                <li style="display: flex;flex-wrap: wrap;padding-bottom: 15px; width: 100%;" id="contact_name">
                    <div style="display: flex; flex-wrap: wrap;padding-top: 30px;justify-content: center;width: 100%;"
                        ...
                        <div class="title-resume-card" style="padding: 0px 0 20px;">
                            <h1 class="resume-section-heading" style="color: #0f2337;font-size: 36px; margin-bottom: 0; text-transform: capitalize; font-weight: 700; position: relative;letter-spacing: 0.25px;">
                                <span style="position: relative; z-index: 3;">{{ $resume->contact_info['name'] }}</span>

                            </h1>

                        </div>
                        <div class="icon-box-top" style="width: 100%;display: flex;justify-content: center;">
                            @if(isset($resume->contact_info['phone']))
                                <div class="icon-box"
                                    ...
                                    <span
                                        style="margin-left: 20px;font-size: 15px;">{{ $resume->contact_info['phone'] }}</span>
                                </div>
                            @endif
                            @if(isset($resume->contact_info['email']))
                                <div class="icon-box"
                                    ...
                                    <span
                                        style="margin-left: 20px;font-size: 15px;">{{ $resume->contact_info['email'] }}</span>
                                </div>
                            @endif
            ...
            <div class="experience-info" style="display: flex; padding: 10px 0 15px;">
                <ul class="sortable contact-info-right"
                    style="width: 62%; display: inline-block; position: relative; margin-right: 3%;border-right: 2px solid #f8b6ce;padding-right: 3%;">
                    @foreach($resume->sortable as $value)
                        @if($value == "summary")
                            <li id="summary" class="contact-border-line summ-p" style="padding-bottom: 60px;">
                                <div class="summary">
                                    <div class="resumeAction">
                                    ...
                                    <div class="inner-box-text">
                                        <h3 style="color: #fc6880;font-size: 21px; text-transform: capitalize; font-weight: 700; margin-bottom: 20px; position: relative; padding-bottom: 3px; width: 100%;" class="resume-section-heading">
                        ...
                        @if($value == "experience")
                            <li class="education-card-right-inner title-bg">
                                <div class="experience">
                                    ...
                                    <h3 class="resume-section-heading" style="color: #fc6880;font-size: 21px; text-transform: capitalize; font-weight: 700;margin-bottom: 20px; position: relative; padding-bottom: 3px; width: 100%;">
                                    ...
                                    <div class="education-bottom-box"
                                        ...
                                        <div class="education-bottom-box-right">
                                            <div class="box-title"
                                                ...
                                                <span
                                                    style="font-size: 10px; line-height: 18px; color:#fc6880;">@if(isset($experience['start_month']))
                        ...
                        @if(isset($resume->extra_section) && !empty($resume->extra_section))
                            @foreach($resume->extra_section as $sectionKey => $section)
                                @if(!in_array($sectionKey,$resume->sortable))
                                    <li id="{{ $sectionKey }}" style="padding-bottom: 60px;">
                                ...
                                <li class="skills-info" style="padding-top: 55px;    width: 100%;">
                                    <div class="skills-info-left title-bg skills">
                                        <div class="skills-info-box">
                                            ...
                                            <h3 style="font-size: 21px; text-transform: capitalize; font-weight: 700;    color: #fc6880;margin-bottom: 20px; position: relative; padding-bottom: 3px; width: 100%;" class="resume-section-heading">
