...
@section('content')
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="header">
                    <h2><strong>Create </strong> Template</h2>
                </div>
                <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group required">
                                    ...
                                    <input type="text" name="path"
                                           ...
                                           placeholder="Enter Template Path" value="{{ old('path') }}">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group required">
                                    ...
                                    <select name="tag"
                                        ...
                                        @endphp
                                        @foreach($tags as $tag)
                                            <option value="{{$tag}}" class="text-capitalize">{{$tag}}</option>
                                        @endforeach
                                    </select>
                                    @error('type')
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="checkbox m-t-25">
                                    <input id="required_image" type="checkbox" name="required_image">
