                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group required">
                                    ...
                                    <input type="text" name="title"
                                           ...
                                           placeholder="Enter content title" value="{{ old('title',$prewritten_content->title) }}">
                                    @error('title')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group required">
                                    ...
                                    <textarea rows="5" name="description" class="form-control @error('description') is-invalid @enderror" placeholder="Enter content description">{{ old('description',$prewritten_content->description) }}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
