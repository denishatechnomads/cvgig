            ...
            <div class="container-fluid">
                <div class="title-row">
                    ...
                    <div class="button-group">
                        @if (!Auth::check())
                            <a class="btn primary-btn text-uppercase mr-3" data-toggle="modal" data-target="#downloadModal">
                                <i class="fa fa-download"></i><span> {{ __('fields.download') }}</span>
                            </a>
                            <a class="btn btn-outline-secondary text-uppercase mr-3" data-toggle="modal" data-target="#downloadModal">
                                <i class="fa fa-print"></i><span> {{ __('fields.print') }}</span>
                            </a>
                            <a class="btn btn-outline-secondary text-uppercase" data-toggle="modal" data-target="#downloadModal">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                                ...
                                <form class="" method="POST" action="{{ route('resume.save') }}" autofocus="off">
                                    ...
                                    <div>
                                        <a class="btn btn-outline-secondary text-center text-uppercase"
                                           href="{{ route('resume.summary') }}">{{__('fields.back') }}</a>
                                        @if (!Auth::check())
                            ...
                            <div class="col-md-1 col-sm-1 color-box mt-30">
                                @php
                                    $colors = [
                                ...
                                @foreach($colors as $color)
                                    <div
                                        class="item mt-3 @if(isset($resume->style_section['color']) && $resume->style_section['color'] == $color) selected @endif"
                                        data-code="{{ $color }}"></div>
                                @endforeach
                            </div>
                            <div class="col-md-2 col-sm-3 mt-30">

                                <div class="mb-4">
                                    <a href="#" class=" dashed-box text-center text-dark" data-toggle="modal"
                                       data-target="#sectionModal">
                                        <img src="{{ asset('front/images/add.svg')}}" height="40" class="mb-4 mt-4"
                                             alt="">
                                        <h5 class="fw-600 mb-3">{{ __('message.addSection') }}</h5>
                                    </a>
                                </div>
{{--                                <div class="">--}}
...
{{--                                             alt="">--}}
{{--                                        <h2 class="fw-600 mb-3">{{ __('message.spellCheck') }}</h2>--}}
{{--                                    </a>--}}
{{--                                </div>--}}
                            </div>
                        </div>
                    ...
                    <div class="col-sm-3 template_card">
                        <h5 class="pb-2">{{ __('message.changeTemplate') }}</h5>
                        <div class="templateList">
                            @foreach($templates as $template)
                                <div class="row">
                                    <div class="col-sm-12 pb-10">
                                        <a href="#" class="text-center text-dark">
                                            <div class="card border-dark mr-10">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".color-box .item").click(function () {
                ...
                {{-- @if($resume->template->id == 16)
                    $('.green-bg').css('background-color', $(this).data('code'));
                @endif  --}}
            });
            ...
            $(".addSection").bind("click", function () {
                ...
                window.location.href = "/cvgig/public/resume/" + {{ $resume->id }} +"/section/" + section;
            });
